   	...
   	<div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navcol">
            ...
            <!-- 이해리님 요청 -->
                ...
                <c:if test="${phone==null && admin == null}">
                    <a id="login2" class="nav-link" style="width: 10%; float: right; cursor : pointer;" onclick="window.open('login2','login2','width=585,height=450,location=no,status=no,scrollbars=yes,left=700,top=200');">로그인</a>
                </c:if>
...
<%--                 <c:if test="${session_banner!=null}">
                ...
                <c:if test="${admin != null }"><!-- 관리자 환영합니다 스타일 수정 황선필-->
                	...
                	<a href="ask" class="nav-link" style="width: 10%; float: right;cursor : pointer">1:1문의</a>
