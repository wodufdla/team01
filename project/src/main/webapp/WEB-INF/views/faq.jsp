        ...
        <div class="table-responsive table-default" style="max-width: 1200px;">
            <table class="table">
                <tbody>
                    ...
                    <tr>
                        <td>서비스 해지 안내</td>
                        <td>서비스 해지 방법은 1:1 문의 게시판을 이용하시면 해지 가능합니다.<br>해지가 정상 진행되시면 해지 문자를 받으실 수 있습니다. 이후 별도의 추가 결제는 발생하지 않습니다.<br>무료기간(168시간)이 지나 정상 구독되어 서비스 비용이 결제되면 이후 취소나 환불이 어려운 점 참고 부탁드립니다.</td>
                    </tr>
                    <tr>
                        <td>탈퇴안내</td>
                        <td>회원탈퇴는 1:1 문의작성해 주시면 탈퇴처리 되시면, 범죄 알리미 서비스에서는 휴대폰번호 외 개인정보를 수집하여  회원들만 탈퇴하실 수 있습니다.</td>
                    </tr>
                </tbody>
            </table>
