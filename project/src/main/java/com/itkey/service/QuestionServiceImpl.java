...
public class QuestionServiceImpl implements QuestionService {
	...
	@Override
	public QuestionVO selectAsk2(int ask_No) {
		log.info("* [SERVICE] Input  ◀ (Controller) : " + toString());
		QuestionVO returnList = questionDAO.selectAsk2(ask_No);
		log.info("* [SERVICE] Output ◀ (DAO) : " + returnList.toString());
		return returnList;
	}
	
	@Override
	public QuestionVO ansUpdateSelect(int ask_No) {
		log.info("* [SERVICE] Input  ◀ (Controller) : " + toString());
		QuestionVO returnList = questionDAO.ansUpdateSelect(ask_No);
		log.info("* [SERVICE] Output ◀ (DAO) : " + returnList.toString());
		return returnList;
	}
